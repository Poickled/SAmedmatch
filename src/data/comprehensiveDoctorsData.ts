// Comprehensive medical facilities data with robust error handling
...
export const comprehensiveDoctorsData: Doctor[] = [
  {
  ...
  // This dataset now includes 60+ facilities with robust error handling for missing data
];

export default comprehensiveDoctorsData;
